...
class AppThemes {
  ...
  static String font1 = "Medium";
  static String font2 = "Medium";
  ...
  static const TextTheme _lightTextTheme = TextTheme(
    ...
    bodyMedium: TextStyle(fontSize: 14.0, color: kGrey, fontFamily: "Medium"),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    inputDecorationTheme: const InputDecorationTheme(
      prefixStyle: TextStyle(color: _darkIconColor, fontFamily: "Medium"),
