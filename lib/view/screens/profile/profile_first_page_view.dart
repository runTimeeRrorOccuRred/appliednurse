...
// class ProfileFirstPage extends ConsumerStatefulWidget {
//   const ProfileFirstPage({super.key});

//   @override
//   ConsumerState<ProfileFirstPage> createState() => _ProfileFirstPageState();
// }

// class _ProfileFirstPageState extends ConsumerState<ProfileFirstPage> {
...
//           ),
//           const Padding(
//             padding: EdgeInsets.only(left: AppSizes.p20, right: AppSizes.p20),
//             child: Card(
//               elevation: 0,
//               color: Colors.white,
//               child: Padding(
...
//                     Text(
//                       "👍",
//                       style: TextStyle(fontSize: AppSizes.p24),
//                     ),
//                   ],
//                 ),
//               ),
...
//                       '30%',
//                       style:
//                           TextStyle(color: royalBlue, fontSize: AppSizes.p20),
//                     ),
