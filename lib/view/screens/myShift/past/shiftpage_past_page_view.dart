...
import 'package:applied_nurse/view/screens/myShift/past/widget/myshift_past_item.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class ShiftPagePast extends ConsumerStatefulWidget {
  const ShiftPagePast({super.key});

  @override
  ConsumerState<ShiftPagePast> createState() => _ShiftPagePastState();
}

class _ShiftPagePastState extends ConsumerState<ShiftPagePast> {
