...
class MyShiftUpcomingItem extends StatefulWidget {
  const MyShiftUpcomingItem({
    super.key,
  });

  @override
  State<MyShiftUpcomingItem> createState() => _MyShiftUpcomingItemState();
}

class _MyShiftUpcomingItemState extends State<MyShiftUpcomingItem> {
  @override
                        ...
                        child: const Row(
                          children: [
                            Text(
                              "Get Direction",
                              style: TextStyle(
                                  color: royalBlue, fontSize: AppSizes.p14,),
                            ),
                            Icon(
